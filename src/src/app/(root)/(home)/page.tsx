...
const Home = () => {
  ...
  return (
    <section className='flex size-full flex-col gap-10 text-white'>
      <div className="h-60 w-full rounded-2xl bg-cover" style={{ backgroundImage: 'url("/hero-background.png")' }}>
        <div className='flex h-full flex-col justify-between max-md:px-5 max-md:py-8 lg:p-11'>
          ...
          <div className='flex flex-col gap-2'>
            ...
            <p className='text-lg font-medium text-[#C9DDFF] lg:text-2xl lg:ml-2'>
              {date}
            </p>
          </div>
        </div>
